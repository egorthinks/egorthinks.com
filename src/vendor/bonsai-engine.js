// Vendored from egorthinks/git-bonsai: docs/engine.js, itself generated by that
// repo's scripts/build-playground.js from the compiled action (dist/src).
//
// This is the exact code the GitHub Action runs, so /bonsai/ grows the same tree
// the Action would. Do not edit by hand. To update:
//
//   git clone https://github.com/egorthinks/git-bonsai
//   cd git-bonsai && npm install && npm run build && node scripts/build-playground.js
//   copy docs/engine.js over this file, keeping the header and the export below.
